...
;  A FAIRE:
; - Tester le programme
; - Pour chaque essai (1,2 et 3) indiquez les éléments suivants:
;          + taille maximale de la pile en octet
;          + zone mémoire occupée par la pile (de la mémoire d'adresse XX
;            à la mémoire d'adresse YY)
;          + détailler le contenu de la pile
; - Conclure par rapport à la consigne de segmentation relative à la pile
; - au sujet de la segmentation: voir Poly "Doc TP" chapitre "Macro 
;   assembleur 8051" page 63
;-----------------------------------------------------------------------------
